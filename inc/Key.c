...
void Key_Init(void) {
  ...
  // I.e., PortB has already been reset and activated (do not reset PortB here
  // again) regular inputs
  ...
  IOMUX->SECCFG.PINCM[PB17INDEX] = 0x00040081; // GPIO input
  IOMUX->SECCFG.PINCM[PB18INDEX] = 0x00040081; // GPIO output
  IOMUX->SECCFG.PINCM[PB19INDEX] = 0x00040081; // GPIO output
}
