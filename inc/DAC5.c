...
//   IOMUX->SECCFG.PINCM[PB0INDEX] = 0x81; // GPIO input
//   IOMUX->SECCFG.PINCM[PB1INDEX] = 0x81; // GPIO input
//   IOMUX->SECCFG.PINCM[PB2INDEX] = 0x81; // GPIO output
//   IOMUX->SECCFG.PINCM[PB3INDEX] = 0x81; // GPIO output
//   IOMUX->SECCFG.PINCM[PB4INDEX] = 0x81; // GPIO output
